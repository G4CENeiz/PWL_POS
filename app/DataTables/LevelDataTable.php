    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($level) {
                return '<a href="' . route('level.update', $level->level_id) . '" class="btn btn-primary btn-sm">Edit</a>
                        <a href="' . route('level.delete', $level->level_id) . '" class="btn btn-danger btn-sm">Delete</a>';
            })
            ->rawColumns(['action'])
            ->setRowId('id');
    }
