<div class="sidebar">
   ...
   with font-awesome or any other icon font library -->
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <a href="{{ asset('adminlte/general.html') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>General</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ asset('adminlte/icons.html') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Icons</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ asset('adminlte/buttons.html') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Buttons</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ asset('adminlte/sliders.html') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Sliders</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ asset('adminlte/modals.html') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Modals & Alerts</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ asset('adminlte/navbar.html') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Navbar & Tabs</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ asset('adminlte/timeline.html') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Timeline</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ asset('adminlte/ribbons.html') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Ribbons</p>
                        </a>
                    </li>
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ asset('adminlte/pages/examples/forgot-password-v2.html') }}"
                                    class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                            ...
                            <li class="nav-item">
                                <a href="{{ asset('adminlte/pages/examples/recover-password-v2.html') }}"
                                    class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
